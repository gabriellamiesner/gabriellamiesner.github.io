...
var parse = function parse2(raw) {
  ...
  !!isNaN(result) ? true ? tiny_invariant_esm_default(false, "Could not parse value [raw: " + raw + ", without suffix: " + value + "]") : tiny_invariant_esm_default(false) : void 0;
  return result;
};
...
function setScript(initialValue) {
  ...
  if (colorMode) {
    ...
    root2.style.setProperty("--chakra-ui-color-mode", colorMode);
  }
}
...
var transformFunctions = {
  ...
  flexDirection: function flexDirection(value) {
    ...
    var _ref = (_flexDirectionTemplat = flexDirectionTemplate[value]) != null ? _flexDirectionTemplat : {}, space3 = _ref.space, divide2 = _ref.divide;
    var result = {
      flexDirection: value
    };
    if (space3)
...
var group = {
  ...
  focus: function focus2(selector) {
...
var systemProps = (0, import_lodash.default)({}, background, border, color, flexbox, layout, filter2, ring2, interactivity, grid, others, position, effect, space, typography, textDecoration, transform8, list, transition);
...
var tokenHandlerMap = {
  space: function space2(keys2, value, options) {
    ...
    return {
      ...
      cssMap: _extends4({}, properties.cssMap, (_extends22 = {}, _extends22[negativeLookupKey] = {
        value: "" + negativeValue,
        "var": "" + variable,
        varRef
      }, _extends22))
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  var ele = (0, import_react2.createElement)(type, newProps);
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  hasRendered = true;
  var possiblyStyleElement = (0, import_react3.createElement)(Noop3, null);
...
var createStyled = function createStyled2(tag, options) {
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache, ref) {
      ...
      newProps.className = className;
      newProps.ref = ref;
      var ele = (0, import_react4.createElement)(finalTag, newProps);
      var possiblyStyleElement = (0, import_react4.createElement)(Noop5, null);
      return (0, import_react4.createElement)(import_react4.Fragment, null, possiblyStyleElement, ele);
    });
...
var ThemeProvider3 = function ThemeProvider4(props) {
  ...
  return React4.createElement(ThemeProvider, {
    theme: computedTheme
  }, React4.createElement(Global, {
    styles: function styles(theme2) {
      var _ref;
      return _ref = {}, _ref[cssVarsRoot] = theme2.__cssVars, _ref;
    }
  }), children);
};
function useTheme2() {
...
function useToken(scale, token2, fallback) {
  ...
  if (Array.isArray(token2)) {
    ...
    return token2.map(function(token3, index) {
      ...
      return resolveTokenValue3(theme, path2, (_fallbackArr$index = fallbackArr[index]) != null ? _fallbackArr$index : token3);
    });
  }
...
var Icon = forwardRef3(function(props, ref) {
  ...
  if (element && typeof element !== "string") {
    return React5.createElement(chakra.svg, _extends6({
      as: element
    }, shared, rest));
  }
...
function createIcon(options) {
  var _options$viewBox = options.viewBox, viewBox = _options$viewBox === void 0 ? "0 0 24 24" : _options$viewBox, pathDefinition = options.d, path = options.path, displayName = options.displayName, _options$defaultProps = options.defaultProps, defaultProps = _options$defaultProps === void 0 ? {} : _options$defaultProps;
  var Comp = forwardRef3(function(props, ref) {
    return React5.createElement(Icon, _extends6({
      ref,
      viewBox
    }, defaultProps, props), path != null ? path : React5.createElement("path", {
      fill: "currentColor",
      d: pathDefinition
    }));
  });
...
//# sourceMappingURL=chunk-JUDRIKWE.js.map
